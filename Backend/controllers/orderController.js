...
const placeOrder = async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `${process.env.CLIENT_URL.replace(/\/$/, "")}/verify?success=true&orderId=${newOrder._id}`,
      cancel_url: `${process.env.CLIENT_URL.replace(/\/$/, "")}/verify?success=false&orderId=${newOrder._id}`,
    });
